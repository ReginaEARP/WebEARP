...
export function Navbar({ onLogout }: NavbarProps) {
  ...
  const titulos: Record<string, string> = {
    ...
    '/parceiros': 'Gestão de Parceiros & Médicos',
    '/processos/administrativo': 'Gestão de Processos Administrativos',
    '/processos/juridico': 'Gestão de Processos Jurídico',
    '/clinico': 'Gestão de Consultas e Exames',
