...
import { Administrativo } from './pages/processos/Administrativo';
import { CentralConsultasExamesPage } from './pages/clinico/ConsultasExames'
...
export function AppRoutes({ darkMode, setDarkMode }: AppRoutesProps) {
  ...
  return (
    <Routes>
      ...
      <Route path="/processos/administrativo" element={<Administrativo />} />
      <Route 
        path="/processos/juridico" 
        element={<div className="p-6">Módulo Processos - Jurídico (Em breve)</div>} 
      />
      <Route path="/processos" element={<Navigate to="/processos/administrativo" replace />} />
      <Route path="/clinico" element={<CentralConsultasExamesPage />} />
      ...
      <Route path="/relatorios" element={<div className="p-6">Módulo de Relatórios (Em breve)</div>} />
      <Route path="/processos/administrativo/central-custos" element={<CentralCustosGpsPage />} />
