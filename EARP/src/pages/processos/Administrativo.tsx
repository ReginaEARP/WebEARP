...
export function Administrativo() {
  ...
  const [processos, setProcessos] = useState<Administrativo[]>([]);
  ...
  const [processoParaEditar, setProcessoParaEditar] = useState<Administrativo | null>(null);

  // Controle do Modal de Exclusão
  const [processoParaExcluir, setProcessoParaExcluir] = useState<Administrativo | null>(null);
    ...
    <div className="p-6 space-y-6 max-w-[1400px] mx-auto">
      ...
      <div className="flex flex-col sm:flex-row gap-4 items-center justify-between">
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto">
          ...
          <button
            onClick={() => navigate('/processos/administrativo/central-custos')}
